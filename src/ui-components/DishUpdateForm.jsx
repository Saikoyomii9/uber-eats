...
export default function DishUpdateForm(props) {
  ...
  const [dishRecord, setDishRecord] = React.useState(dish);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Dish, idProp) : dish;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Dish.copyOf(dishRecord, (updated) => {
